...
// 선택된 요소가 복수일 경우, 가장 첫번째 요소만 선택 (무조건 하나만 선택)
...
// Element.textContent : 컨텐츠를 획득 및 변경 //요소의 텍스트 콘텐츠를 가져오거나 설정
// 순수한 텍스트 데이터를 전달
